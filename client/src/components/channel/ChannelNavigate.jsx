...
function ChannelNavigate({ username, edit }) {
      ...
      <>
        <section className="text-white text-center w-full flex justify-evenly items-center border-b-2 border-slate-600 text-xs sm:text-base sm:mt-4 md:mt-0 mt-2">
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? "font-medium text-purple-500 border-b-2 border-purple-500"
                : ""
            }
          >
  ...
  return (
    <>
      {/* channel options */}
      <section className="text-white w-full flex justify-evenly items-center border-b-2 border-slate-600 text-sm sm:text-base sm:mt-4 md:mt-0 my-2">
        <NavLink
